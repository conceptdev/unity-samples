...
public final class HingeAngleSensor {
    private static final String HINGE_ANGLE_SENSOR_TYPE = "microsoft.sensor.hinge_angle";
    //private static final String HINGE_ANGLE_SENSOR_NAME = "Hinge Angle"; // NOT USED, getType()
    ...
    public void setupSensor() {
        ...
        if (mHingeAngleSensor == null) {
            ...
            for (Sensor sensor : sensorList) {
                if (sensor.getStringType().contains(HINGE_ANGLE_SENSOR_TYPE)) {
